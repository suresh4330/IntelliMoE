"""
experts/deeplearning.py
-----------------------
DeepLearningExpert — neural networks and deep learning domain.

Updated to use the Google Gemini API instead of the local TinyLlama model
to provide higher-quality deep learning explanations, neural network architectures, and troubleshooting.
"""
...
class DeepLearningExpert(BaseExpert):
    """Expert for neural networks, transformers, CNNs, and deep learning workflows."""
    ...
    def generation_config(self) -> GenerationConfig:
        return EXPERT_CONFIGS["deeplearning"]

    def answer(self, question: str, memory: "Optional[ConversationMemory]" = None) -> str:
        """
        Generate a deep learning expert answer using the Gemini API.
        ...
        logger.info("DeepLearningExpert: sending request to Gemini API...")
        ...
        try:
            ...
            logger.info("DeepLearningExpert: successfully generated response from Gemini API.")
            return response

        except Exception as exc:
            logger.exception("DeepLearningExpert failed to generate answer using Gemini API.")
            raise RuntimeError(
                f"DeepLearningExpert failed to generate an answer. "
