...
class SystemDesignExpert(BaseExpert):
    """Expert for system design, distributed systems, and architecture queries."""
    ...
    def generation_config(self) -> GenerationConfig:
        return EXPERT_CONFIGS["systemdesign"]
